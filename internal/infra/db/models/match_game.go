...
type MatchGame struct {
	...
	Scores      datatypes.JSONMap `gorm:"column:scores;type:json;comment:玩家分数快照" json:"scores"`
	LastEventID uint              `gorm:"column:last_event_id;index;not null;comment:最新事件ID" json:"last_event_id"`
