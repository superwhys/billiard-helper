...
func newRoom(db *gorm.DB, opts ...gen.DOOption) room {
	...
	_room.roomDo.UseModel(&models.Room{})
	...
	_room.Status = field.NewUint8(tableName, "status")
...
func (a roomHasManyPlayers) Model(m *models.Room) *roomHasManyPlayersTx {
...
func (a roomHasManyPlayersTx) Find() (result []*models.Player, err error) {
	return result, a.tx.Find(&result)
}

func (a roomHasManyPlayersTx) Append(values ...*models.Player) (err error) {
...
func (a roomHasManyPlayersTx) Replace(values ...*models.Player) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roomHasManyPlayersTx) Delete(values ...*models.Player) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roomHasManyScores) Model(m *models.Room) *roomHasManyScoresTx {
...
func (a roomHasManyScoresTx) Find() (result []*models.Score, err error) {
	return result, a.tx.Find(&result)
}

func (a roomHasManyScoresTx) Append(values ...*models.Score) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roomHasManyScoresTx) Replace(values ...*models.Score) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roomHasManyScoresTx) Delete(values ...*models.Score) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IRoomDo interface {
	...
	Unscoped() IRoomDo
	Create(values ...*models.Room) error
	CreateInBatches(values []*models.Room, batchSize int) error
	Save(values ...*models.Room) error
	First() (*models.Room, error)
	Take() (*models.Room, error)
	Last() (*models.Room, error)
	Find() ([]*models.Room, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Room, err error)
	FindInBatches(result *[]*models.Room, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Room) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Room, error)
	FirstOrCreate() (*models.Room, error)
	FindByPage(offset int, limit int) (result []*models.Room, count int64, err error)
...
func (r roomDo) Create(values ...*models.Room) error {
	if len(values) == 0 {
		return nil
	}
...
func (r roomDo) CreateInBatches(values []*models.Room, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r roomDo) Save(values ...*models.Room) error {
	if len(values) == 0 {
		return nil
	}
...
func (r roomDo) First() (*models.Room, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Room), nil
	}
}

func (r roomDo) Take() (*models.Room, error) {
...
func (r roomDo) Last() (*models.Room, error) {
...
func (r roomDo) Find() ([]*models.Room, error) {
	result, err := r.DO.Find()
	return result.([]*models.Room), err
}

func (r roomDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Room, err error) {
	buf := make([]*models.Room, 0, batchSize)
...
func (r roomDo) FindInBatches(result *[]*models.Room, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r roomDo) FirstOrInit() (*models.Room, error) {
...
func (r roomDo) FirstOrCreate() (*models.Room, error) {
...
func (r roomDo) FindByPage(offset int, limit int) (result []*models.Room, count int64, err error) {
...
func (r roomDo) Delete(models ...*models.Room) (result gen.ResultInfo, err error) {
